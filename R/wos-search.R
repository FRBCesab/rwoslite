...
#' (\url{https://developer.clarivate.com/apis/woslite}) and returns the total 
#' number of records that match this query.
#' 
...
#' 
#' @param query a `character` of length 1. The query to send to the WOS lite 
